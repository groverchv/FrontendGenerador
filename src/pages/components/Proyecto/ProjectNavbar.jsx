...
export default function ProjectNavbar({
    ...
    isProcessingImage: isProcessingImageProp,
}) {
    ...
    const finalIsProcessingImage =
        typeof isProcessingImageProp === "boolean" ? isProcessingImageProp : isProcessingImage;
